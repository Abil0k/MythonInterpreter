...
namespace runtime
{
                                     ...
                                     Context &context)
    {
        ...
        {
            closure[class_.GetMethod(method)->formal_params[i]] = actual_args[i];
        }
        return class_.GetMethod(method)->body->Execute(closure, context);
    }
    ...
    {
        auto it = std::find_if(methods_.begin(), methods_.end(), [&name](const auto &method)
    ...
    bool Equal(const ObjectHolder &lhs, const ObjectHolder &rhs, Context &context)
    {
        ...
        if (lhs.TryAs<ClassInstance>() && lhs.TryAs<ClassInstance>()->HasMethod("__eq__"s, 1U))
        {
            return lhs.TryAs<ClassInstance>()->Call("__eq__"s, std::vector<ObjectHolder>{rhs}, context).TryAs<Bool>()->GetValue();
        }
    ...
    bool Less(const ObjectHolder &lhs, const ObjectHolder &rhs, Context &context)
    {
        ...
        if (lhs.TryAs<ClassInstance>() && lhs.TryAs<ClassInstance>()->HasMethod("__lt__"s, 1U))
        {
            return lhs.TryAs<ClassInstance>()->Call("__lt__"s, std::vector<ObjectHolder>{rhs}, context).TryAs<Bool>()->GetValue();
        }
